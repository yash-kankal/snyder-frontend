    ...
    <main className="relative">
      ...
      <div className="wrapper detail-wrapper">
        ...
        <div className="detail-info-row">
          ...
          {/* Left column: description only (stats moved to Where to Watch card) */}
          <div className="detail-info-left">

            {/* Merged card: description only */}
          ...
          <div className="detail-info-right">
            <div className="detail-card detail-hero-watch">
              ...
              <div className="watch-stats-list">
                {show.first_air_date && <div className="watch-stat-row"><svg viewBox="0 0 20 20" fill="#AB8BFF" className="meta-icon"><path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd"/></svg><span className="detail-stat-value">{new Date(show.first_air_date).toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' })}</span></div>}
                {show.number_of_seasons > 0 && <div className="watch-stat-row"><svg viewBox="0 0 20 20" fill="#60a5fa" className="meta-icon"><path d="M2 6a2 2 0 012-2h12a2 2 0 012 2v2a2 2 0 100 4v2a2 2 0 01-2 2H4a2 2 0 01-2-2v-2a2 2 0 100-4V6z"/></svg><span className="detail-stat-value">{show.number_of_seasons} {show.number_of_seasons === 1 ? 'Season' : 'Seasons'}</span></div>}
                {show.number_of_episodes > 0 && <div className="watch-stat-row"><svg viewBox="0 0 20 20" fill="#34d399" className="meta-icon"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd"/></svg><span className="detail-stat-value">{show.number_of_episodes} Episodes</span></div>}
                {show.original_language && <div className="watch-stat-row"><svg viewBox="0 0 20 20" fill="#34d399" className="meta-icon"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.523-1.943A5.977 5.977 0 0116 10c0 .34-.028.675-.083 1H15a2 2 0 00-2 2v2.197A5.973 5.973 0 0110 16v-2a2 2 0 00-2-2 2 2 0 01-2-2 2 2 0 00-1.668-1.973z" clipRule="evenodd"/></svg><span className="detail-stat-value">{LANG_NAMES[show.original_language] || show.original_language.toUpperCase()}</span></div>}
